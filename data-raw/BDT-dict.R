...
BDT_dict_raw <- readxl::read_excel("data-raw/BDT_dict.xlsx")
BDT_dict_raw[BDT_dict_raw$key == "SAMPLE_QUESTION", "DE"] <- "**Beispiel {{no_example}}/2**\\\\War der Beep-Ton **auf** oder **neben** dem Beat?"
BDT_dict_raw[BDT_dict_raw$key == "SAMPLE_QUESTION", "DE_F"] <- "**Beispiel {{no_example}}/2**\\\\War der Beep-Ton **auf** oder **neben** dem Beat?"
